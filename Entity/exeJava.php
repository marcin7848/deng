...
class exeJava
{
    ...
    public function setExeJava($id, $idExeName, $first, $second, $word, $comment, $working, $mode, $repeated, $done, $today, $lastPerfectNum, $lastPerfect)
    {
        $this->id = $id;
    ...
    public function setExeJavaCopy($exeJava){
        return $exeJava;
    }
