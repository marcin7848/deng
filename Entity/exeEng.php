...
class exeEng
{
    ...
    public function setExeEng($id, $idExeName, $first, $second, $word, $comment, $working, $mode, $repeated, $done, $today, $lastPerfectNum, $lastPerfect)
    {
        $this->id = $id;
    ...
    public function setExeEngCopy($exeEng){
        return $exeEng;
    }
